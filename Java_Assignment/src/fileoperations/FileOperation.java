...
public class FileOperation {
	...
	//Append content in the Existing file
	...
	// get all the properties from the file
	 public static void getFileProperties(Scanner scanner) {
		...
		while(true) {
			try {
				...
				if(choice >= 1 && choice <= 12) {
					...
					System.out.println("Invalid choice. Please Enter number between 1 to 12 : ");
				}
	...
	//Search file from the directory
	...
	private static void displayMenu() {
        ...
        System.out.println("3. Write data to a file");
        System.out.println("4. Read data from a file");
        System.out.println("5. Append data in a file");
        System.out.println("6. Copy the content of one text file to another");
        System.out.println("7. Delete file from a directory");
        System.out.println("8. List all file from  directory");
        System.out.println("9. Search for a file");
        System.out.println("10. Rename a file");
        System.out.println("11. Get all the properties of file");
